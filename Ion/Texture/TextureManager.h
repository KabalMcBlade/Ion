...
public:
    ...
    Texture*    GenerateTexture(const eosString& _name, ionU32 _width, ionU32 _height, ETextureFormat _format, ETextureRepeat _repeat, ionU32 _numLevel = 1, ionU32 _maxAnisotrpy = 1);
