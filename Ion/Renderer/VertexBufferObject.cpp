...
// File: C:\Projects\Ion\Ion\Renderer\VertexBufferObject.cpp
...
void VertexBuffer::ReferenceTo(const VertexBuffer& _other)
{
...
void VertexBuffer::ReferenceTo(const VertexBuffer& _other, ionSize _refOffset, ionSize _refSize)
{
    ionAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void VertexBuffer::Update(const void* _data, ionSize _size, ionSize _offset /*= 0*/) const
{
...
void* VertexBuffer::MapBuffer(EBufferMappingType _mapType)
{
