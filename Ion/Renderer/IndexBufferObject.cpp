...
// File: C:\Projects\Ion\Ion\Renderer\IndexBufferObject.cpp
...
void IndexBuffer::ReferenceTo(const IndexBuffer& _other)
{
...
void IndexBuffer::ReferenceTo(const IndexBuffer& _other, ionSize _refOffset, ionSize _refSize)
{
    ionAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void* IndexBuffer::MapBuffer(EBufferMappingType _mapType)
{
