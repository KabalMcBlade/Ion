...
ionBool RenderManager::CreatePhysicalDevice()
{
    ...
    ionAssertReturnValue(result > 0, "vkEnumeratePhysicalDevices returned zero devices.", false);
...
ionBool RenderManager::CreateSwapChain()
{
    return false;   // TO DO
}
...
ionBool RenderManager::Init(HINSTANCE _instance, HWND _handle, ionBool _enableValidationLayer)
{
